...
export default function LiveAllocationUpdateModal({
  ...
  const currentAllocation = useMemo(() => session?.allocation || {}, [session?.allocation]);
  const [allocationType, setAllocationType] = useState(currentAllocation.allocation_type || "FIXED");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await liveTradingApi.updateAllocation(currentAllocation.id, payload);
        ...
        <form onSubmit={handleSubmit} className="space-y-6 py-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder={
                allocationType === "FIXED" ? "e.g. 50000" : "e.g. 10"
              }
          ...
          <div className="p-3 bg-blue-500/10 border border-blue-500/20 rounded-lg text-xs text-blue-300">
            Note: Updating allocation will affect future orders. Existing
            positions will not be automatically adjusted.
          </div>
