...
export default function AIResearchAssistant() {
  return (
    ...
    //       </div>
    //       <CardTitle className="text-slate-100">AI Research Assistant</CardTitle>
    ...
    //         Get personalized stock picks, market analysis, and trading insights powered by advanced AI.
    //       </p>
    //     </CardContent>
    //   </Card>
    // </div>
