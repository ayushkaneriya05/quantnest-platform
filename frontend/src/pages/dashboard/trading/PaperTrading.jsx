...
export default function PaperTrading() {
  ...
  return (
    <div className="h-screen bg-[#0d1117] text-white flex flex-col overflow-hidden">
      {/* Centered Modern Tabbar */}
      <div className="flex-shrink-0 border-b border-gray-800/50 bg-[#161b22]">
        <div className="flex justify-center py-4">
          <Tabs defaultValue="trading" className="w-full max-w-2xl">
            <TabsList className="grid w-full grid-cols-3 bg-[#21262d] border border-gray-700/50 rounded-xl p-1 shadow-lg">
              <TabsTrigger 
                value="trading" 
                className="data-[state=active]:bg-[#0969da] data-[state=active]:text-white data-[state=active]:shadow-md bg-transparent text-gray-400 hover:text-gray-200 hover:bg-gray-800/50 border-0 rounded-lg px-6 py-3 font-medium transition-all duration-200"
              >
            ...
            {/* Main Content Area - Fixed Height to Prevent Page Scrolling */}
            <div className="h-[calc(100vh-100px)]">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-3">
                          <Button
                            ...
                            className="bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-2 font-semibold transition-all duration-200 shadow-lg hover:shadow-emerald-500/25"
                          >
                            Buy
                          </Button>
                          <Button
                            onClick={() => handleOpenOrderModal("SELL")}
                            className="bg-red-600 hover:bg-red-700 text-white px-6 py-2 font-semibold transition-all duration-200 shadow-lg hover:shadow-red-500/25"
                          >
                            Sell
                          </Button>
                        </div>
              ...
              <TabsContent value="portfolio" className="h-full m-0 p-0 bg-[#0d1117]">
                <div className="h-full overflow-y-auto scrollbar-thin scrollbar-track-gray-800 scrollbar-thumb-gray-600 p-6">
