      ...
      <CardContent className="p-6">
        ...
        <div className="flex items-center justify-between p-3 rounded-lg bg-gray-900/50">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-slate-300">P&L</span>
          </div>
      ...
      <CardContent className="p-6">
        <div className="flex items-start justify-between mb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Badge variant="outline" className="text-xs border-gray-600 text-slate-400">
              {order.order_type}
            </Badge>
          </div>
        </div>
    ...
    <div className="space-y-8">
      ...
      <div>
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-bold text-slate-100">Active Positions</h2>
        </div>
      ...
      <div>
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-bold text-slate-100">Pending Orders</h2>
        </div>
