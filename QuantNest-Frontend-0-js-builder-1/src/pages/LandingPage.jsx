  ...
  return (
    <div className="flex flex-col min-h-screen bg-black font-sans">
      ...
      <main className="flex-1">
          ...
          <div className="container px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
            <div className="grid grid-cols-2 gap-4 sm:gap-6 lg:grid-cols-4 md:gap-8">
              <div className="text-center p-4 sm:p-5 md:p-6 rounded-xl sm:rounded-2xl bg-gray-900/50 shadow-[inset_0_2px_4px_rgba(255,255,255,0.05),inset_0_-2px_4px_rgba(0,0,0,0.3)] border border-gray-800/50">
                <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-indigo-300 font-heading">$2.5B+</div>
                <div className="text-xs sm:text-sm font-medium text-slate-400 mt-1 sm:mt-2">Assets Under Management</div>
              </div>
              <div className="text-center p-4 sm:p-5 md:p-6 rounded-xl sm:rounded-2xl bg-gray-900/50 shadow-[inset_0_2px_4px_rgba(255,255,255,0.05),inset_0_-2px_4px_rgba(0,0,0,0.3)] border border-gray-800/50">
                <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-purple-300 font-heading">50K+</div>
                <div className="text-xs sm:text-sm font-medium text-slate-400 mt-1 sm:mt-2">Active Traders</div>
              </div>
              <div className="text-center p-4 sm:p-5 md:p-6 rounded-xl sm:rounded-2xl bg-gray-900/50 shadow-[inset_0_2px_4px_rgba(255,255,255,0.05),inset_0_-2px_4px_rgba(0,0,0,0.3)] border border-gray-800/50">
                <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-pink-300 font-heading">99.99%</div>
                <div className="text-xs sm:text-sm font-medium text-slate-400 mt-1 sm:mt-2">System Uptime</div>
              </div>
              <div className="text-center p-4 sm:p-5 md:p-6 rounded-xl sm:rounded-2xl bg-gray-900/50 shadow-[inset_0_2px_4px_rgba(255,255,255,0.05),inset_0_-2px_4px_rgba(0,0,0,0.3)] border border-gray-800/50">
                <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-cyan-300 font-heading">15+</div>
        ...
        <section id="about" className="py-20 sm:py-24 lg:py-32 bg-black">
          <div className="container px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-center mb-16 sm:mb-20">
              ...
              <p className="text-base leading-7 text-slate-400 sm:text-lg sm:leading-8">
                At QuantNest, we are driven by a passion for empowering traders with <span className="text-indigo-300 font-medium">cutting-edge technology</span> and unparalleled insights. Our journey began with a simple idea: to democratize <span className="text-purple-300 font-medium">sophisticated algorithmic trading tools</span>, making them accessible to everyone from individual traders to large institutions.
              </p>
            </div>
        ...
        {/* CTA Section */}
        <section id="contact" className="py-20 sm:py-24 lg:py-32 bg-gradient-to-br from-indigo-900/50 to-purple-900/50">
          <div className="container px-4 sm:px-6 lg:px-8">
